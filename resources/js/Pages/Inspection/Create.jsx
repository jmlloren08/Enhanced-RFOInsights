...
import { PiJarLabelThin } from "react-icons/pi";
                        ...
                        <div className="border-b border-gray-900/10 pb-12">
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <p className="mt-1 text-sm/6 text-gray-600">
                                    ...
                                    Inspection entry. Ensure all details are
                                ...
                                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div className="sm:col-span-4">
                                        ...
                                        <div className="mt-2 grid grid-cols-1">
                                            <select
                                                value={
                                                    data.department_office_inspected
                                                }
                                                onChange={(e) =>
                                                    setData(
                                                        "department_office_inspected",
                                            ...
                                            >
                                                ...
                                                <option value="Business Permits and Licensing Office (BPLO)">
                                                ...
                                                <option value="Social Welfare and Development Office (SWDO)">
                                                    Social Welfare and
                                                ...
                                                <option value="Planning and Development Office">
                                                    Planning and Development
                                                    Office
                                                </option>
                                                <option value="Zoning Office">
                                                    Zoning Office
                                                </option>
                                                <option value="Environmental and Natural Resources Office (ENRO)">
                                                    Environmental and Natural
                                                    Resources Office (ENRO)
                                                </option>
                                                <option value="Building Official’s Office">
                                                    Building Official’s Office
                                                </option>
                                                <option value="Local Civil Registrar">
                                                    Local Civil Registrar
                                                </option>
                                                <option value="Public Employment Service Office (PESO)">
                                                ...
                                                <option value="Agriculture Office">
                                                    Agriculture Office
                                                </option>
                                                <option value="Barangay Affairs Office">
                                    ...
                                    <div className="sm:col-span-2 sm:col-start-1">
                                        ...
                                        <div className="mt-2">
                                            <input
                                                type="date"
                                                placeholder="Deadline for Compliance"
                                                value={
                                                    data.deadline_for_compliance
                                                }
                                                onChange={(e) =>
                                                    setData(
                                                        "deadline_for_compliance",
                            ...
                            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div className="col-span-full">
                                    <label className="block text-sm/6 font-medium text-gray-900">
                                        Findinds/Observations
                                    </label>
                                    <div className="mt-2">
                                        <textarea
                                            value={data.findings_observations}
                                            onChange={(e) =>
                                                setData(
                                                    "findings_observations",
                                                    e.target.value
                                    ...
                                    <p className="mt-3 text-sm/6 text-gray-600">
                                        ...
                                        Citizen Charter Inspection submission.
                                    </p>
                                </div>
                                <div className="sm:col-span-2 sm:col-start-1">
                                    <label className="block text-sm/6 font-medium text-gray-900">
                                    ...
                                    <div className="mt-2">
                                        <input
                                            type="text"
                                            placeholder="Deficiencies Noted (if any)"
                                            value={data.deficiences_noted}
                                            onChange={(e) =>
                                                setData(
                                                    "deficiences_noted",
                                                    e.target.value
                                ...
                                <div className="sm:col-span-2">
                                    <label className="block text-sm/6 font-medium text-gray-900">
                                        Follow-up Inspection Date (if
                                        applicable)
                                    </label>
                                    <div className="mt-2">
                                        <input
                                            type="date"
                                            placeholder="Follow-up Inspection Date (if
                                        applicable)"
                                            value={
                                                data.follow_up_inspection_date
                                            }
                                            onChange={(e) =>
                                                setData(
                                                    "follow_up_inspection_date",
                                ...
                                <div className="col-span-full">
                                    <label
                                        htmlFor="recommendations_for_improvement"
                                        className="block text-sm/6 font-medium text-gray-900"
                                    >
                                    ...
                                    <div className="mt-2">
                                        <textarea
                                            value={
                                                data.recommendations_for_improvement
                                            }
                                            onChange={(e) =>
                                                setData(
                                                    "recommendations_for_improvement",
                                    ...
                                    <p className="mt-3 text-sm/6 text-gray-600">
                                        ...
                                        improvement, including any suggestions
                                        for the office to improve its compliance
                                        with the Citizen's Charter.
                                    </p>
                                </div>
                                <div className="col-span-full">
                                    <label className="block text-sm/6 font-medium text-gray-900">
